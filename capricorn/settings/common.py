...
FIXTURE_DIRS = (
    str(SRC_DIR.path('fixtures')),
)

LOG_DIR = ROOT_DIR.path("logs") # settings
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                'core.context_processors.pass_server_environment'
...
# Async jobs
WORKER_SETTING = env('WORKER_SETTING', default='SERVER')
